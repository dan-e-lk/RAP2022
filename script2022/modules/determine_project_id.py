...
class Determine_project_id:
	...
	def __init__(self, cfg_dict, db_filepath, tablenames_n_rec_count, logger):
		...
		self.cur = None
		self.clearcut_tbl_name = 'Clearcut_Survey_v2022'
		self.shelterwood_tbl_name = 'Shelterwood_Survey_v2022'
		...
		self.user_spec_proj_id_field = 'ProjectID' # Name of the ProjectID field that the field crew enters to the form.
